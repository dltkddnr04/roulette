...
이 포크를 실제로 군교회 식기조 추첨에 사용하다 보니 또 다른 문제가 생겼습니다. 제가 속한 중대가 정말 우연히도 약 3개월 동안 한 번도 식기조에 걸리지 않았고, 다른 중대 인원들은 “저 중대는 방송부 부장이 소속돼 있어서 그런지 계속 안 걸리네. 부장이 설거지하기 싫어서 조작하는 것 아니냐?”고 자주 농담하곤 했습니다.

하지만 실제로는 아무런 조작도 하지 않았습니다. 완전히 무작위로 추첨했는데도 결과가 오랫동안 한쪽으로 치우친 것이었습니다.

그래서 반대로 생각했습니다. **완전히 무작위인 추첨이 항상 공평한 결과를 만드는 것은 아니라면, 차라리 모두가 공평하게 한 번씩 걸리도록 조작하자.** 특정 사람을 피하게 만드는 조작이 아니라, 이전 추첨 결과를 기억하고 장기적인 쏠림을 줄이는 방향으로 추첨에 개입하는 것입니다.

그 생각에서 **누적 공정성(Cumulative Fairness)** 기능이 시작됐습니다.
