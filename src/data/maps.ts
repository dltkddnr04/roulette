...
export const stages: StageDef[] = [
  {
    ...
    entities: [
      ...
      // boxes
      {
        ...
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: -Math.PI / 4 },
        type: 'static',
      ...
      },
      {
        ...
        type: 'static',
        shape: { type: 'box', width: 0.6, height: 0.1, rotation: Math.PI / 4 },
        props: { density: 1, angularVelocity: 0, restitution: 0 },
      },
      {
  ...
  },
  {
    ...
    entities: [
      ...
      },
      {
        ...
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: -Math.PI / 4, color: '#818fb4' },
        type: 'static',
        props: { density: 1, angularVelocity: 0, restitution: 1 },
      },
      {
...

      {
        ...
        type: 'static',
        shape: { type: 'box', width: 0.1, height: 0.1, rotation: -Math.PI / 2, color: '#c7ffd8' },
...

      {
        ...
        type: 'static',
        shape: { type: 'box', width: 0.1, height: 0.1, rotation: -Math.PI / 2, color: '#98ded9' },
        props: { density: 1, angularVelocity: 1.2, restitution: 0 },
      },
      {
      ...
      },
      {
        ...
        type: 'kinematic',
        shape: { type: 'box', width: 4.0, height: 0.1, rotation: Math.PI / 6, color: '#610c9f' },
        props: { density: 1, angularVelocity: 0.32, restitution: 0 },
      },
      {
        position: { x: 18.5, y: 140.0 },
        type: 'kinematic',
        shape: { type: 'box', width: 4.0, height: 0.1, rotation: -Math.PI / 6, color: '#872341' },
        props: { density: 1, angularVelocity: -0.32, restitution: 0 },
      },
      {
        position: { x: 4.5, y: 150.0 },
        type: 'kinematic',
        shape: { type: 'box', width: 5.0, height: 0.1, rotation: Math.PI / 3, color: '#503c3c' },
        props: { density: 1, angularVelocity: 0.32, restitution: 0 },
      },
      {
        position: { x: 18.5, y: 150.0 },
        type: 'kinematic',
        shape: { type: 'box', width: 5.0, height: 0.1, rotation: -Math.PI / 3, color: '#5c5470' },
        props: { density: 1, angularVelocity: -0.32, restitution: 0 },
      },
      {
        position: { x: 4.5, y: 160.0 },
        type: 'kinematic',
        shape: { type: 'box', width: 4.0, height: 0.1, rotation: Math.PI / 2, color: '#1a3636' },
        props: { density: 1, angularVelocity: 0.32, restitution: 0 },
      },
      {
        position: { x: 18.5, y: 160.0 },
        type: 'kinematic',
        shape: { type: 'box', width: 4.0, height: 0.1, rotation: -Math.PI / 2, color: '#522258' },
        props: { density: 1, angularVelocity: -0.32, restitution: 0 },
      },
